		...
		var dataSource = new kendo.data.DataSource({
			transport: {
	     	...
	     	requestEnd: function(e) {
		        ...
		        window.sessionStorage.setItem('message', "Updated action of getDetail : " + response[0].message.toUpperCase());
		...
		var dataSource = new kendo.data.DataSource({
			transport: {
	     	...
	     	requestEnd: function(e) {
		        ...
		        window.sessionStorage.setItem('message', "Saved action of getDetail : " + response[0].message.toUpperCase());
		        window.location.href = "groupMaintenanceList";
			}
		});
