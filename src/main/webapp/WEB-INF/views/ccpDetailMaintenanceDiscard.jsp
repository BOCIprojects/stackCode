			...
			var dataSource = new kendo.data.DataSource({
                    ...
                    $.each(jsonObj, function(i){
						...
						$("#ccd_id_label").html("<label>"+jsonObj[i].ccdId+"</label>");
							...
							$("#buttonType").html("<button id=\"submitBtn\"  type=\"button\" data-role=\"button\" class=\"k-button\" role=\"button\" aria-disabled=\"false\" tabindex=\"0\" onclick=\"toUpdate()\">YES</button><label>    </label><button id=\"submitBtn\" onclick=\"toDiscard()\" type=\"button\" data-role=\"button\" class=\"k-button\" role=\"button\" aria-disabled=\"false\" tabindex=\"0\">NO</button>");
	...
	<body>
		...
		<table border="0" style="background-color:#fabf8f">
			...
			<tr>
				...
				<td width="250" style="font-size:13px"><label id="remarks"></label></td>
			</tr>			
		</table>
		<br/>
